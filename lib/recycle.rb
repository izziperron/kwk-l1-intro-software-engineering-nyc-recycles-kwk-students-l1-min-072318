...
def address(first_recycle_bin, second_recycle_bin, third_recycle_bin, fourth_recycle_bin)
  puts first_recycle_bin["address"]
  puts second_recycle_bin["address"]
  puts third_recycle_bin["address"]
  puts fourth_recycle_bin["address"]
end

address(first_recycle_bin, second_recycle_bin, third_recycle_bin, fourth_recycle_bin)
